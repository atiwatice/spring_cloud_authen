...
import com.test.config.RedisHashComponent;
import com.test.dto.ApiKey;
import com.test.util.AppConstants;

@SpringBootApplication
public class SpringCloudGatewayAuthenApplication {
	 @Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringCloudGatewayAuthenApplication.class, args);
	}
